...
public class TblDatas {
    ...
    public TblDatas(){}
    public TblDatas(int m_counter, String m_fio, String m_acc, String m_summ, Integer m_PP) {
    ...
    /*public TblDatas(String m_fio, String m_acc, String m_summ) {
        this.m_FIO = m_fio;
        this.m_ACC = m_acc;
        this.m_SUMM = m_summ;
    }*/
    ...
    public int getM_counter(){return  m_counter;}
    public void setM_counter(int mm_counter){m_counter = mm_counter;}
}
